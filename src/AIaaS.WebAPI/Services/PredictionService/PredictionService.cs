...
namespace AIaaS.WebAPI.Services.PredictionService
{
    public class PredictionService : IPredictionService
    {
        ...
        public PredictionService(EfContext dbContext, IPredictionBuilderDirector predictionBuilderDirector)
        {
        ...
        private dynamic MergeInputParameterWithPrediction(Models.PredictionParameter predictParameter, object? aPrediction)
        {
        ...
        private object? GeneratePrediction(Models.PredictionParameter predictParameter)
        {
