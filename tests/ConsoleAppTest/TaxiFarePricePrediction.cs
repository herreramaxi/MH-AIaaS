...
{
    public class TaxiFarePricePrediction
    {
        private static string AppPath => Path.GetDirectoryName(Environment.GetCommandLineArgs()[0]);

        private static string BaseDatasetsRelativePath = @"../../../../Data";
        private static string TrainDataRelativePath = $"taxi-fare-train.csv";
        private static string TestDataRelativePath = $"taxi-fare-test.csv";

        private static string TrainDataPath = GetAbsolutePath(TrainDataRelativePath);
        private static string TestDataPath = GetAbsolutePath(TestDataRelativePath);

        private static string BaseModelsRelativePath = @"../../../../MLModels";
        private static string ModelRelativePath = $"TaxiFareModel.zip";
        ...
        {  //Create ML Context with seed for repeatable/deterministic results
            ...
            PlotRegressionChart(mlContext, TestDataPath, 100, new string[] { });
